    ...
    <div class="row p-3">
        <div class="col-md-6 order-one">
            ...
            <div class="row mb-2 destinations-sections" id="id_about">
                <p class="mb-0 mr-auto p-2 text-left"><i class="flaticon flaticon-profiles"></i> &nbsp; <?php echo get_post_meta($post_id,'', true)?></p>
            </div>
            <div class="row">
                <p><?php echo get_post_meta($post_id,'wyw_content_page_detail_description', true)?></p>
            </div>

            <!-- Include -->
            <div class="row mb-2 destinations-sections" id="id-details">
                <p class="mb-0 mr-auto p-2 text-left"><i class="flaticon flaticon-verified"></i> &nbsp; <?php echo get_post_meta($post_id,'wyw_content_page_include_service', true)?></p>
            </div>
            <div class="row">
                <p><?php echo get_post_meta($post_id,'wyw_content_page_include_description', true)?></p>
            </div>
        </div>
        <!-- Right side-->
        <div class="col-md-6 order-two">
            <h1 class="hotel-subtitle"><?php the_title(  )?></h1>
            <h4 class="hotel-subtitle-2"><?php echo get_post_meta( $post_id, 'wyw_content_page_content_subtitle', true)?></h4>
